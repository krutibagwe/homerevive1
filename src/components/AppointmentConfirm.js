...
const AppointmentConfirmation = () => {
    ...
    const { provider, bookingDate, bookingTime } = location.state || {};
        ...
        <div className="confirmation-container">
            ...
            <div className="confirmation-content">
                ...
                <div className="details">
                    ...
                    <p><strong>Date:</strong> {bookingDate}</p> {/* Display booking date */}
                    <p><strong>Time:</strong> {bookingTime}</p> {/* Display booking time */}
