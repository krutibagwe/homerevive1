    ...
    const handleBooking = async (e) => {
        ...
        try {
            const bookingData = {
                ...
                userUid,
                timestamp: new Date(),
                providerName: '', // Placeholder for provider name
            };
            ...
            // Navigate with booking date, time, and booking ID included
            navigate('/available-providers', { 
                state: { 
                    pincode, 
                    service: mainService.title, 
                    ...
                    bookingDate, 
                    bookingTime,
                    bookingId: bookingDocRef.id // Pass the booking ID for later use
                } 
            });
            console.log("Navigating to available providers");
